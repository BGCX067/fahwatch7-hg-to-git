...
Namespace myCuda
    ...
    End Structure
    Public Enum CUDeviceAttribute2 As UInt32
    ...
    End Enum
    Public Enum CUDeviceAttribute1
        CU_DEVICE_ATTRIBUTE_MAX_THREADS_PER_BLOCK = 1
        CU_DEVICE_ATTRIBUTE_MAX_BLOCK_DIM_X = 2
        CU_DEVICE_ATTRIBUTE_MAX_BLOCK_DIM_Y = 3
        CU_DEVICE_ATTRIBUTE_MAX_BLOCK_DIM_Z = 4
    ...
    Public Structure cudaAPI
        ...
        End Function
        <DllImport("nvcuda.dll")> _
        Public Overloads Shared Function cuDeviceGetAttribute(ByRef ReturnValue As Int32, ByVal CUDeviceAttribute As myCuda.CUDeviceAttribute1, ByVal CUDevice As myCuda.CUdevice) As myCuda.cudaError
        End Function
        <DllImport("nvcuda.dll")> _
        Public Overloads Shared Function cuDeviceGetAttribute(ByRef ReturnValue As Int32, ByVal CUDeviceAttribute As myCuda.CUDeviceAttribute2, ByVal CUDevice As myCuda.CUdevice) As myCuda.cudaError
        End Function
        <DllImport("nvcuda.dll")> _
