...
#End Region
#Region "Structures"
    <StructLayout(LayoutKind.Sequential)> Public Structure CALfunc
        Public Value As UInt32
    End Structure

    <StructLayout(LayoutKind.Sequential)> Public Structure CALfuncInfo
    ...
    <StructLayout(LayoutKind.Sequential)> Public Structure CALimage
    ...
    <StructLayout(LayoutKind.Sequential)> Public Structure CALobject
        Public Value As IntPtr
    End Structure

    <StructLayout(LayoutKind.Sequential)> Public Structure CALprogramGrid
    ...
    <StructLayout(LayoutKind.Sequential)> Public Structure CALmem
        Public Value As UInt32
    End Structure

    <StructLayout(LayoutKind.Sequential)> Public Structure CALdevicestatus
    ...
    <StructLayout(LayoutKind.Sequential)> Public Structure CALmodule
        Public Value As UInt32
    End Structure
    ...
    <StructLayout(LayoutKind.Sequential)> Public Structure CALdomain
    ...
    <StructLayout(LayoutKind.Sequential)> Public Structure CALcontext
        Public Value As UInt32
    End Structure

    <StructLayout(LayoutKind.Sequential)> Public Structure CALdomain3D
        Public width As UInteger
        Public height As UInteger
        Public depth As UInteger
    End Structure

    <StructLayout(LayoutKind.Sequential)> Public Structure CALprogramGridArray
    ...
    <StructLayout(LayoutKind.Sequential)> Public Structure CALresource
        Public Value As UInt32
    End Structure

    <StructLayout(LayoutKind.Sequential)> Public Structure CALevent
        Public Value As UInt32
    End Structure
