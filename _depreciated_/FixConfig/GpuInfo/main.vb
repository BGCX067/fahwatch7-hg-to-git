            ...
            Public Structure scudaDevice
                ...
                Public ReadOnly Property DeviceAttributes() As Array
                    Get
                        Dim r(0 To alProperties.Count - 1) As sProperty
                        Try
                            For xInt As Int16 = 0 To alProperties.Count
                                r(xInt) = CType(alProperties(xInt), sProperty)
                            Next
                        Catch ex As Exception
                        ...
                        For xInt As Int32 = 0 To dCount - 1
                            ...
                            Else
                                ...
                                Try
                                    ...
                                    'Dim infoNames3() As String = [Enum].GetNames(GetType(myCuda.CUDeviceAttribute3))
                                    'Dim infoValues3() As UInt32 = [Enum].GetValues(GetType(myCuda.CUDeviceAttribute3))
                                    'CudaDevice.AddNames(infoNames, infoValues)
                                    'Dim clDI3 As myCuda.CUDeviceAttribute3
                                    'For YInt As Int32 = 0 To infoNames.Count - 1
                                    '    Debug.WriteLine(infoNames(YInt) & " " & infoValues(YInt))
                                    '    clDI3 = infoValues(YInt)
                                    '    Dim rVal As Int32
                                    '    If myCuda.cudaAPI.cuDeviceGetAttribute(rVal, clDI3, deviceID) = myCuda.cudaError.cudaSuccess Then
                                    '        CudaDevice.SetValue(infoValues(YInt), rVal)
                                    '    End If
                                    'Next
