            ...
            Public Function cudaReport() As String
                ...
                Try
                    ...
                    If cudaInf.DeviceCount > 0 Then
                        ...
                        For xint As Int32 = 0 To cudaInf.DeviceCount - 1
                            Dim mC As cudaInfo.scudaDevice = cudaInf.Devices(xint)
        ...
        Public Class cOHMInterface
            ...
            Public Class ohmADL
                ...
                Public ReadOnly Property Report As String
                    Get
                        Dim sb As New StringBuilder
                        Try
                            sb.AppendLine("Ati Display Library" & Environment.NewLine & Environment.NewLine & "Status: " & Me.Status & Environment.NewLine & Environment.NewLine & "Number of GPUs: " & Me.NumberOfAdapters.ToString & Environment.NewLine & "Driver Version: " & Me.DriverString & " Release: " & Me.ReleaseString & Environment.NewLine & Environment.NewLine)
                            For Index = 0 To Me.NumberOfAdapters - 1
            ...
            Private Function NVIDsFromRegistry() As List(Of sNVRegistry)
                Try
                    ...
                    For Each moObj In moSearch.Get
                        'Check for Nvidia
                        If moObj.Item("AdapterCompatibility").ToString.ToUpper.Contains("NVIDIA") Then
                            Dim ni As New sNVRegistry
                            ni.DeviceName = moObj.Item("Caption")
                            ni.DeviceID = moObj.Item("PNPDeviceID")
                            nl.Add(ni)
                        End If
                    Next
                    Return nl
            ...
            Private Function AtiDriverStringWMI() As String
                Try
                    ...
                    For Each moObj In moSearch.Get
                        'Check for Nvidia
                        If moObj.Item("AdapterCompatibility").ToString.ToUpper.Contains("ATI") Then
                            Return moObj.Item("DriverVersion")
                        End If
                    Next
                Catch ex As Exception
            ...
            Public Function Init() As Boolean
                ...
                If _ohmReport.Contains(vbCrLf & "NVAPI" & vbCrLf) Then
                    ...
                    For xShort As Short = 1 To _NVAPI.NumberOfAdapters
                        ...
                        nGpu.DeviceID = lstNV(xShort - 1).DeviceID
...
#End Region
        Public Function Init() As Boolean
            Try
                ...
                Static bOhm As Boolean
                Static bGpu As Boolean
                Static bEnv As Boolean
                If Not bOnce Then
                    bOhm = ohmInterface.Init
                    bGpu = gpuInf.initGpuInfo
                    bEnv = Territory.FillEnvironment
                    bOnce = True
                End If
                Return bOhm AndAlso bGpu AndAlso bEnv
            Catch ex As Exception
                Return False
            End Try
        End Function
