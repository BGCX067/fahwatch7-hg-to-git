...
Public Class frmProjectBrowser
    Private cProject As clsProjectInfo.sProject
    ...
    Public Function ShowBrowser(ByVal OwnerForm As Form, Optional ByVal Pnumber As String = "0") As Boolean
        ...
        For x = 1 To ProjectInfo.ProjectCount
            cmbProjects.Items.Add(ProjectInfo.ProjectNumber(x))
        Next
        If ProjectInfo.KnownProject(Pnumber) Then
    ...
    Public Function RefreshBrowser()
        Try
            ...
            Me.Text = "Project browser - known projects: " & ProjectInfo.ProjectCount
            Return True
    ...
    Private Sub ImportToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ImportToolStripMenuItem.Click
        ...
        With fBrowser
            ...
            If .ShowDialog(Me) And .FileName <> "" Then
                If Not ProjectInfo.ParseFile(.FileName) Then MsgBox("Could not parse selected file.")
            End If
        End With
    End Sub
