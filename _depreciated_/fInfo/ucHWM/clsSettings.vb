    ...
    Public Class sSettings
        ...
        Public Sub GetObjectData(ByVal info As System.Runtime.Serialization.SerializationInfo, ByVal context As System.Runtime.Serialization.StreamingContext) Implements System.Runtime.Serialization.ISerializable.GetObjectData
            With info
                ...
                .AddValue("AutoConnect", AutoConnect)
            End With
        End Sub
        ...
        Public Enum eHistoryLimit
            ...
            OneMonth = 4
        End Enum
        Public HistoryLimit As eHistoryLimit
        ...
        Public lsPCI As Boolean
        Public Automation As Boolean
        Public intOHM As Double
        Public intSQ As Double
        Public intOPT As Double
...
#End Region
        Protected Sub New(ByVal info As SerializationInfo, ByVal context As StreamingContext)
            Try
                ...
                SafeMode = info.GetBoolean("SafeMode")
                ...
                AutoConnect = info.GetBoolean("AutoConnect")
            Catch ex As Exception
    ...
    Public Sub SetDefaults()
        Try
            With _Settings
                ...
                .HistoryLimit = sSettings.eHistoryLimit.OneWeek
